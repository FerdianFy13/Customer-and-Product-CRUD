...
?>
    ...
    <div class="container" style="margin-top:30px">
        <div class="row">
            <div class="col-sm-12">
                <h2>Kelola Produk</h2>
                <a href="form_create.php" class="btn btn-info" role="button">Tambah Produk</a>
...
$no = 0;
while ($produk = mysqli_fetch_assoc($hasil)) { // simpan dalam array assosiatif
    /*echo "<pre>";
    print_r($produk);
    echo "</pre>";*/
    $no++;
    ?>
                            <tr>
                                ...
                                <td>
                                    <a href="form_update.php?id=<?=$produk['id']?>">Edit</a>
                                    <a href="confirm_delete.php?id=<?=$produk['id']?>">Delete</a>
                                </td>
                            </tr>
                            <?php
}
